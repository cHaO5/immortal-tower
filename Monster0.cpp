...
void Monster0::BoundDetect(float dt)
{
	...
	if (GameManager::getInstance()->currentPlayer->getBoundingBox().intersectsRect(Monster0_weapon->getBoundingBox()))
	{
        ...
        Vector< SpriteFrame* > frameVec;
        if (arc > -0.3926 && arc <= 0.3926) {  //turn U
            GameManager::getInstance()->currentPlayer->setTexture("U-1attacked.png");
//            frame=SpriteFrame::create("U.png",Rect(0,0,128,256));
//            frameVec.pushBack(frame);
        } else if (arc > 0.3926 && arc <= 1.1781) {  //turn UR
            GameManager::getInstance()->currentPlayer->setTexture("UR-1attacked.png");
//            frame=SpriteFrame::create("UR.png",Rect(0,0,128,256));
//            frameVec.pushBack(frame);
        } else if (arc > 1.1781 && arc <= 1.9635) {  //turn R
            GameManager::getInstance()->currentPlayer->setTexture("R-1attacked.png");
//            frame=SpriteFrame::create("R.png",Rect(0,0,128,256));
//            frameVec.pushBack(frame);
        } else if (arc > 1.9635 && arc <= 2.7489) {  //turn DR
            GameManager::getInstance()->currentPlayer->setTexture("DR-1attacked.png");
//            frame=SpriteFrame::create("DR.png",Rect(0,0,128,256));
//            frameVec.pushBack(frame);
        } else if (arc > 2.7489 || arc <= -2.7489) {  //turn D
            GameManager::getInstance()->currentPlayer->setTexture("D-1attacked.png");
//            frame=SpriteFrame::create("D.png",Rect(0,0,128,256));
//            frameVec.pushBack(frame);
        } else if (arc > -1.1781 && arc <= -0.3926) {  //turn UL
            GameManager::getInstance()->currentPlayer->setTexture("UL-1attacked.png");
//            frame=SpriteFrame::create("UL.png",Rect(0,0,128,256));
//            frameVec.pushBack(frame);
        } else if (arc > -1.9635 && arc <= -1.1781) {  //turn L
            GameManager::getInstance()->currentPlayer->setTexture("L-1attacked.png");
//            frame=SpriteFrame::create("L.png",Rect(0,0,128,256));
//            frameVec.pushBack(frame);
        } else if (arc > -2.7489 && arc <= -1.9635) {  //turn DL
            GameManager::getInstance()->currentPlayer->setTexture("DL-1attacked.png");
//            frame=SpriteFrame::create("DL.png",Rect(0,0,128,256));
//            frameVec.pushBack(frame);
        }
        GameManager::getInstance()->currentPlayer->setTexture("DL-1attacked.png");
