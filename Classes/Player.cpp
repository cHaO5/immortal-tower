...
bool Player::setPlayerPosition(Point position)
{
	...
	int y = static_cast<int>((_tileMap->getMapSize().height*_tileMap->getTileSize().height - _tileMap->getMapSize().height - position.y) / _tileMap->getTileSize().height);
